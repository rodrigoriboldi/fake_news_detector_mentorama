...
cv = pickle.load(open('fake_news_detector_mentorama/modelos/bag_of_words.sav', 'rb'))

# Importando modelos
rf_classifier = pickle.load(open('fake_news_detector_mentorama/modelos/random_forrest.sav', 'rb'))
xgb_classifier = pickle.load(open('fake_news_detector_mentorama/modelos/xgboost.sav', 'rb'))
svm_classifier = pickle.load(open('fake_news_detector_mentorama/modelos/svm.sav', 'rb'))
nb_classifier = pickle.load(open('fake_news_detector_mentorama/modelos/naive_bayes.sav', 'rb'))

# Importando exemplos
df_validation = pd.read_csv('fake_news_detector_mentorama/dados/df_validation.csv').drop(columns = ['Unnamed: 0', 'title'])
...
with open('fake_news_detector_mentorama/metricas/model_metrics.json', 'r') as openfile:
